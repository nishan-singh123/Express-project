 ...
 * Method: POST
 */
router.post("/", roleBasedAuth(ROLE_USER), validate(orderSchema), orderController.createOrder);
 ...
 * Method: PUT
 */
router.put("/:id/status", validate(orderStatusSchema), roleBasedAuth(ROLE_ADMIN), orderController.updateOrderStatus);
 ...
 * Method: POST
 */
router.post("/:id/payment/cash", roleBasedAuth(ROLE_USER), orderController.orderPaymentViaCash);
